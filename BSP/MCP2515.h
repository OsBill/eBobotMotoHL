...
/*	Recieve	Filters	*/
// 滤波器0 对应buff0
#define	RXF0SIDH		0x00	// 标准帧
#define	RXF0SIDL		0x01	// 标准帧
#define	RXF0EID8		0x02	// 扩展帧
#define	RXF0EID0		0x03	// 扩展帧
// 滤波器1 对应buff0
...
/* Receive0	Masks */
#define	RXM0SIDH		0x20	// 标准帧
#define	RXM0SIDL		0x21	// 标准帧
#define	RXM0EID8		0x22	// 扩展帧
#define	RXM0EID0		0x23	// 扩展帧
/* Receive1	Masks */
#define	RXM1SIDH		0x24	// 标准帧
#define	RXM1SIDL		0x25	// 标准帧
#define	RXM1EID8		0x26	// 扩展帧
#define	RXM1EID0		0x27	// 扩展帧

/* Tx Buffer 0 */
#define	TXB0CTRL		0x30	// TX Buffer0 控制寄存器
#define	TXB0SIDH		0x31	// TX Buffer0 标准帧ID寄存器H SID10～SID3
#define	TXB0SIDL		0x32	// TX Buffer0 标准帧ID寄存器L SID2～SID0及扩展标识符使能位EXIDE	及EID17、EID16
#define	TXB0EID8		0x33	// TX Buffer0 扩展帧ID寄存器H EID15～EID8
#define	TXB0EID0		0x34	// TX Buffer0 扩展帧ID寄存器H EID7～EID0
#define	TXB0DLC			0x35	// TX Buffer0 数据长度码 DLC3～DLC0	及RTR：0=发送的报文为数据帧
#define	TXB0D0			0x36	// TX Buffer0 数据寄存器0
#define	TXB0D1			0x37
#define	TXB0D2			0x38
#define	TXB0D3			0x39
#define	TXB0D4			0x3A
#define	TXB0D5			0x3B
#define	TXB0D6			0x3C
#define	TXB0D7			0x3D	// TX Buffer0 数据寄存器7
...
/* CANINTE */
#define	RX0IE			0x01		// 接收缓冲器0 满中断使能位	RXB0 装载报文时中断
#define	RX1IE			0x02		// 接收缓冲器1 满中断使能位	RXB1 装载报文时中断
#define	TX0IE			0x04		// 发送缓冲器0 空中断使能位	TXB0 为空时中断
#define	TX1IE			0x80		// 发送缓冲器1 空中断使能位	TXB1 为空时中断
#define	TX2IE			0x10		// 发送缓冲器2 空中断使能位	TXB2 为空时中断
#define	ERRIE			0x20		// 错误中断使能位（EFLG	寄存器中有多个中断源）EFLG 错误条件变化时中断
#define	WAKIE			0x40		// 唤醒中断使能位 CAN总线上有活动时中断
#define	MERRE			0x80		// 报文错误中断使能位 报文接收或发送期间发生错误时中断

// CANINTF Register	Bits			// 中断标志位
#define	RX0IF			0x01		// 接收缓冲器0 满中断
#define	RX1IF			0x02		// 接收缓冲器1 满中断
#define	TX0IF			0x04
#define	TX1IF			0x80
#define	TX2IF			0x10
#define	ERRIF			0x20
...
#define	CAN_RD_RX0		0x90		// 读取接收缓冲器0 开始于RXB0SIDH
#define	CAN_RD_RXD0		0x92		// 读取接收缓冲器0 开始于RXB0D0
#define	CAN_RD_RX1		0x94		// 读取接收缓冲器1 开始于RXB1SIDH
#define	CAN_RD_RXD1		0x96		// 读取接收缓冲器1 开始于RXB1D0
#define	CAN_LOAD_TX0	0X40
#define	CAN_LOAD_TXD0	0X41
#define	CAN_LOAD_TX1	0X42
#define	CAN_LOAD_TXD1	0X43
#define	CAN_LOAD_TX2	0X44
#define	CAN_LOAD_TXD2	0X45

// Define SPI Instruction Set 官网下载
...
extern void	CAN_Send_Buffer0(unsigned char *CAN_TX_Buf);
extern void	CAN_Send_Buffer1(unsigned char *CAN_TX_Buf);
extern void	CAN_Send_Buffer2(unsigned char *CAN_TX_Buf);
extern void CAN_Receive_Buffer0(unsigned char *CAN_RX_Buf,unsigned char CAN_RD_RXDn);
...
extern unsigned char g_u08CANReceiveBufferWriteIndex	;
extern unsigned char g_u08CANReceiveBufferReadIndex	;
